                ...
                <div data-aos="fade-up"
                    ...
                    <div data-aos="fade-right" className="w-full max-w-xl p-5 rounded-xl ">
                        ...
                        <div className='flex items-center justify-evenly my-8'>
                            <div onClick={() => {
                                window.open('https://github.com/BharatMalhi');
                            ...
                            <div onClick={() => {
                                window.open('https://www.linkedin.com/in/bharat-kumar-aa777a177/')
                            ...
                            <div onClick={() => {
                                window.open('https://web.facebook.com/bk.makani/')
                        ...
                        <div className='card'>
                            ...
                            <figure style={{ justifyContent: 'flex-start' }} className='flex items-center' >
                                ...
                                <a href="tel:+8801737509339">+923322971459</a>
                            </figure>
                        </div>
                        <div className='my-5'>
                            ...
                            <figure style={{ justifyContent: 'flex-start' }} className='flex items-center' >
                                ...
                                <a href="mailto:kumarmalhi158@gmail.com">kumarmalhi158@gmail.com</a>
                            </figure>
                        </div>
                        <div>
                            ...
                            <figure style={{ justifyContent: 'flex-start' }} className='flex items-center' >
                                ...
                                <address>Scheme-33 Near Gulisttan-E-Iqbal Karachi </address>
                            </figure>
                        </div>
                    </div>
