            ...
            <div className='text-left flex flex-col md:flex-row justify-center items-center md:gap-20'>
                <div data-aos="fade-left">
                    <div>
                        ...
                        <progress className="progress progress-success h-3 w-70" value="80" max="100"></progress>
                    </div>
                    <div>
                ...
                <div data-aos="fade-right">
                    ...
                    <div>
                        ...
                        <progress className="progress progress-success h-3 w-56" value="50" max="100"></progress>
                    </div>
                    <div>
