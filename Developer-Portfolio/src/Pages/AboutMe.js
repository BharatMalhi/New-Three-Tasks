...
import aboutMeImage from '../Assests/Images/second.jpg';
            ...
            <div data-aos="zoom-out-left" className="hero">
                <div className="hero-content flex-col lg:flex-row gap-6 md:gap-20">
                    ...
                    <div className='w-xs md:max-w-4xl'>
                        ...
                        <p className="py-6 md:pr-8">My name is Bharat Kumar. I am a junior web developer.My sole purpose is to create new websites all the time. Always try to work with advanced technology and with
                            total concentration to be user-friendly. But I am always ready to take on a challenge so that I can learn
                            something new.This year I have completed my degree in Information Technology from Benazir Bhutto Shaheed University Lyari Karachi Pakistan.</p>
                        <a className='btn btn-accent' href="Ph:+92332971459">Contact Me</a>
                    </div>
                </div>
            </div>
        </div>
